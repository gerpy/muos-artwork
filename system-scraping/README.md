...
Here are original white and black logos, as displayed on your current GitHub theme. 
...
- Resize with a pixel number, and not witdh or height so as to balance long and square logos (change the adaquate variable at the begining of the script)
